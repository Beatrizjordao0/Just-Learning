...
Repositório consolidado de exercícios, aulas e pequenos protótipos produzidos durante cursos, ensino técnico e a graduação em Ciência da Computação.

Os projetos maiores continuam em repositórios próprios. Aqui ficam conteúdos de aprendizagem que não justificam um repositório separado.
...
Alguns códigos são registros históricos do processo de aprendizagem e podem usar versões antigas de bibliotecas. Consulte o README da pasta antes de executar um mini-projeto com dependências externas.
